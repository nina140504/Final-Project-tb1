...
pygame.display.set_caption("Suitcase Sort - Rules")
...
background_path = os.path.join(project_root, "Images", "minigame_suitcase", "suitcasesort_title.png")
...
# rules text lines
rules = [
    "HELP! The SUITCASES GOT ALL MESSED UP!",
    "Sort the suitcases correctly.",
    "Blue cases go into the bin, red ones on the conveyour.",
    "corectly sorted = +1 point",
    "Use arrow keys to navigate suitcases",
    "Launch them with them with SPACE BAR",
    "Sort as many suitcases until time runs out",
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if arrow_rect.collidepoint(event.pos):
                ...
                minigame_path = os.path.join(project_root, "Mini Games", "suitcasesort", "suitcase_game.py")
