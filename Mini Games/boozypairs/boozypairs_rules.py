...
pygame.display.set_caption("Boozy Pairs - Rules")
...
background_path = os.path.join(project_root, "Images", "minigame_boozypairs", "BoozyPairs_title_02.png")
...
# rules text lines
rules = [
    "MATCH each ingredient to the correct cocktail!",
    "FLIP two cards at a time to find a pair.",
    "MATCHED cards stay visible.",
    "WRONG guesses flip back.",
    "Correct pair = +5 points.",
    "Incorrect pair = -1 point.",
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if arrow_rect.collidepoint(event.pos):
                ...
                minigame_path = os.path.join(project_root, "Mini Games", "boozypairs", "boozypairs_game.py")
