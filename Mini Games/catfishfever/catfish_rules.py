...
background_path = os.path.join(project_root, "Images", "minigame_catfishfever", "Welsfieber_titel.png")
...
# rules text lines
rules = [
    "YOU ARE SNORKELING IN MADEIRA!",
    "AVOID the fish.",
    "(especially the catfish of brombachsee)",
    "USE the arrow keys.",
    "1 second survived = +1 point",
    "HIT a fish -> GAME OVER!",
